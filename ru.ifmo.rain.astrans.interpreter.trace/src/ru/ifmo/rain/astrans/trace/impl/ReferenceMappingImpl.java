...
public class ReferenceMappingImpl extends EObjectImpl implements ReferenceMapping {
		...
		if (proto != null && proto.eIsProxy()) {
			...
			if (proto != oldProto) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, TracePackage.REFERENCE_MAPPING__PROTO, oldProto, proto));
			}
		}
		return proto;
	}
	...
	public void setProto(EReference newProto) {
		...
		proto = newProto;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TracePackage.REFERENCE_MAPPING__PROTO, oldProto, proto));
	}
	...
	public EStructuralFeature getImage() {
		if (image != null && image.eIsProxy()) {
			...
			if (image != oldImage) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, TracePackage.REFERENCE_MAPPING__IMAGE, oldImage, image));
			}
		}
		return image;
	}
	...
	public void setImage(EStructuralFeature newImage) {
		...
		image = newImage;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TracePackage.REFERENCE_MAPPING__IMAGE, oldImage, image));
	}
	...
	public void setType(ReferenceMappingType newType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, TracePackage.REFERENCE_MAPPING__TYPE, oldType, type));
	}
