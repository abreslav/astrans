 ...
 * <ul>
 *   <li>{@link ru.ifmo.rain.astrans.astrans.MappedEClass#getProto <em>Proto</em>}</li>
 * </ul>
 * </p>
 *
 * @see ru.ifmo.rain.astrans.astrans.AstransPackage#getMappedEClass()
 * @model
 * @generated
 */
public interface MappedEClass extends EClassReference {
	 ...
	 * @see #setProto(EClass)
	 * @see ru.ifmo.rain.astrans.astrans.AstransPackage#getMappedEClass_Proto()
	 * @model required="true"
	 * @generated
	 */
	EClass getProto();
	...
	/**
	 * Sets the value of the '{@link ru.ifmo.rain.astrans.astrans.MappedEClass#getProto <em>Proto</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
