...
public abstract class AssignmentASImpl extends EObjectImpl implements AssignmentAS {
	...
	public void setExpression(ExpressionAS newExpression) {
		if (newExpression != expression) {
			...
			if (expression != null)
				msgs = ((InternalEObject)expression).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AssignastPackage.ASSIGNMENT_AS__EXPRESSION, null, msgs);
			if (newExpression != null)
				msgs = ((InternalEObject)newExpression).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AssignastPackage.ASSIGNMENT_AS__EXPRESSION, null, msgs);
			msgs = basicSetExpression(newExpression, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AssignastPackage.ASSIGNMENT_AS__EXPRESSION, newExpression, newExpression));
	}
