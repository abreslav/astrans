 ...
 * <ul>
 *   <li>{@link assign.impl.BooleanLiteralImpl#isValue <em>Value</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class BooleanLiteralImpl extends ExpressionImpl implements BooleanLiteral {
	...
	protected EClass eStaticClass() {
		return AssignPackage.Literals.BOOLEAN_LITERAL;
	}
	...
	public void setValue(boolean newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AssignPackage.BOOLEAN_LITERAL__VALUE, oldValue, value));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case AssignPackage.BOOLEAN_LITERAL__VALUE:
