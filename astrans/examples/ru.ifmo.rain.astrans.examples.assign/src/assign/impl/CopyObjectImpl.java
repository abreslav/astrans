...
public class CopyObjectImpl extends ExpressionImpl implements CopyObject {
	...
	public void setObject(Expression newObject) {
		if (newObject != object) {
			...
			if (object != null)
				msgs = ((InternalEObject)object).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AssignPackage.COPY_OBJECT__OBJECT, null, msgs);
			if (newObject != null)
				msgs = ((InternalEObject)newObject).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AssignPackage.COPY_OBJECT__OBJECT, null, msgs);
			msgs = basicSetObject(newObject, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AssignPackage.COPY_OBJECT__OBJECT, newObject, newObject));
	}
