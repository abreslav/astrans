...
import ru.ifmo.rain.astrans.astrans.EClassifierReference;
 ...
 * <ul>
 *   <li>{@link ru.ifmo.rain.astrans.astrans.impl.TranslateReferencesImpl#getModelReferenceTypeProto <em>Model Reference Type Proto</em>}</li>
 *   <li>{@link ru.ifmo.rain.astrans.astrans.impl.TranslateReferencesImpl#getTextualReferenceType <em>Textual Reference Type</em>}</li>
 *   <li>{@link ru.ifmo.rain.astrans.astrans.impl.TranslateReferencesImpl#isIncludeDescendants <em>Include Descendants</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TranslateReferencesImpl extends ActionImpl implements TranslateReferences {
		...
		if (modelReferenceTypeProto != null && modelReferenceTypeProto.eIsProxy()) {
			...
			if (modelReferenceTypeProto != oldModelReferenceTypeProto) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, AstransPackage.TRANSLATE_REFERENCES__MODEL_REFERENCE_TYPE_PROTO, oldModelReferenceTypeProto, modelReferenceTypeProto));
			}
		}
	...
	public void setModelReferenceTypeProto(EClass newModelReferenceTypeProto) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AstransPackage.TRANSLATE_REFERENCES__MODEL_REFERENCE_TYPE_PROTO, oldModelReferenceTypeProto, modelReferenceTypeProto));
	}
	...
	public void setTextualReferenceType(EClassifierReference newTextualReferenceType) {
		if (newTextualReferenceType != textualReferenceType) {
			...
			if (textualReferenceType != null)
				msgs = ((InternalEObject)textualReferenceType).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - AstransPackage.TRANSLATE_REFERENCES__TEXTUAL_REFERENCE_TYPE, null, msgs);
			if (newTextualReferenceType != null)
				msgs = ((InternalEObject)newTextualReferenceType).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - AstransPackage.TRANSLATE_REFERENCES__TEXTUAL_REFERENCE_TYPE, null, msgs);
			msgs = basicSetTextualReferenceType(newTextualReferenceType, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AstransPackage.TRANSLATE_REFERENCES__TEXTUAL_REFERENCE_TYPE, newTextualReferenceType, newTextualReferenceType));
	}
	...
	public void setIncludeDescendants(boolean newIncludeDescendants) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AstransPackage.TRANSLATE_REFERENCES__INCLUDE_DESCENDANTS, oldIncludeDescendants, includeDescendants));
	}
