...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Abstract Class Mapping Rule</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link ru.ifmo.rain.astrans.astransformation.impl.AbstractClassMappingRuleImpl#getResolverMethodName <em>Resolver Method Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class AbstractClassMappingRuleImpl extends MappingRuleImpl implements AbstractClassMappingRule {
	/**
	 ...
	 * @generated
	 */
	protected AbstractClassMappingRuleImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return AstransformationPackage.Literals.ABSTRACT_CLASS_MAPPING_RULE;
	}
	...
	public void setResolverMethodName(String newResolverMethodName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AstransformationPackage.ABSTRACT_CLASS_MAPPING_RULE__RESOLVER_METHOD_NAME, oldResolverMethodName, resolverMethodName));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case AstransformationPackage.ABSTRACT_CLASS_MAPPING_RULE__RESOLVER_METHOD_NAME:
