 ...
 * <ul>
 *   <li>{@link ru.ifmo.rain.astrans.astransformation.impl.ParameterImpl#getName <em>Name</em>}</li>
 *   <li>{@link ru.ifmo.rain.astrans.astransformation.impl.ParameterImpl#getType <em>Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ParameterImpl extends EObjectImpl implements Parameter {
	...
	protected EClass eStaticClass() {
		return AstransformationPackage.Literals.PARAMETER;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AstransformationPackage.PARAMETER__NAME, oldName, name));
	}
